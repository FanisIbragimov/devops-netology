...
3. Ввести lsof | grep (deleted) для просмотра удаленных файлов, но оставшихся ссылках на них. Если мы хотим освободить место на диске основываясь на знаниях о перенаправлении потоков можно выполнить > /proc/PID процесса/fd/5 будет окончательно удален.  
